...
\begin{fframe}
    ...
    \vaihto\pause
    Myös alleviivaus on mahdollista. Siihen kannattaa käyttää esim. \cns{soulutf8}-paketin \lstinline-\ul--komentoa, joka sallii alleviivattujen sanojen tavutuksen.
%    \vaihto\pause
