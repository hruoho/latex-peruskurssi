...
\theoremstyle{remark}
\newtheorem{harjoitus}{Harjoitus}[section]

% Encoding magic (http://tex.stackexchange.com/a/145361/23378)
\makeatletter
...
\newenvironment{harj}
    {\VerbatimEnvironment
     \stepcounter{harjoitus}
     \deactivateeightbit\begin{VerbatimOut}{harj\theharjoitus.tex}}
     {\end{VerbatimOut}
     \addtocounter{harjoitus}{-1}
     \begin{harjoitus}
         \inputencoding{utf8}   % "\reactivateeightbit"
         \input{harj\theharjoitus.tex}
     \end{harjoitus}}
