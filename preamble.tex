...
\lstset{
    ...
    escapechar=<>,
    morekeywords={\part,\chapter,\subsection,\subsubsection,\paragraph,\subparagraph,\middle,\theoremstyle,\eqref,\subsetneq,\usetikzlibrary,\definecolor,\tableofcontents,\maketitle},
    literate={ä}{{\"a}}1
             {Ä}{{\"A}}1
             {ö}{{\"o}}1
             {Ö}{{\"O}}1
