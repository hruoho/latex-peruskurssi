...
\begin{frame}[fragile]
    ...
    \begin{itemize}[<+->]
        \item \emph{Vanha \TeX-tapa} kirjoittaa kaava tekstin sekaan on \verb-$kaava$-, esim.
            \begin{Verbatim}[frame=single]
Yhtälön $2x+1=0$ ratkaisu on $x=-1/2$.
            \end{Verbatim}
        \item Tätä käytetään paljon myös \LaTeX{}issa, mutta se rikkoo joitain paketteja ja voi tehdä virheilmoituksista entistä kryptisempiä.
        \item Käännöksissä tuleva virheilmoitus ''\texttt{Missing \$ inserted.}'' tulee tästä:
        \item Se tarkoittaa, että kirjoitit matematiikkaa ei-matematiikkatilassa tai ei-matematiikkaa matematiikkatilassa. \LaTeX{} (tarkemmin sanottuna \TeX{}) huomasi tämän ja yritti (sisäisesti) korjata asian.
        \item Korjaa virhe esim. lisäämällä puuttuva \verb-\)-; älä lisää \verb-$--merkkejä.
        \item \TeX-tapa kaavarivin tuottamiseen taas on \verb-$$kaava$$-, joka rikkoo vielä enemmän asioita. {\color{red}Sitä ei pitäisi \LaTeX{}issa käyttää ollenkaan!}
    \end{itemize}
...
\begin{frame}[fragile]
    \frametitle{Figure-ympäristön argumentit}
    Usein haluttaisiin sijoittaa kelluva ympäristö \underline{tähän} kohtaan tekstiä \textit{no matter what}. Tämä \emph{ei} välttämättä onnistu argumentilla \verb-[h]- tai edes \verb-[!h]-. Itse asiassa \LaTeX{} korvaa argumentin \verb-h- automaattisesti argumentilla \verb-ht-, joten se siitä.
    \pause
    \vaihto
    \underline{Tähän} sijoittaminen onnistuu kuitenkin \verb-float--paketilla. Tällöin esittelyosaan on lisättävä rivi \verb-\usepackage{float}-, jonka jälkeen kelluvalle ympäristölle voi antaa argumentin \verb-[H]-, joka toteuttaa toiveesi, oli jälki miten rumaa tahansa\dots Argumentin \verb-H- kanssa ei voi käyttää muita; esim. \verb-[Hp]- on laiton yhdistelmä.
    \pause
    \vaihto
    \input{harj3_2}
\end{frame}
